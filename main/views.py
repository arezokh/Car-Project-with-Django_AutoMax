...
def inquire_listing_using_email(request, id):
    ...
    try:
        ...
        emailMessage = f'Hi {listing.seller.user.username}, {request.user.username} is interested in your {listing.model} listing in AutoMax.'
        send_mail(emailSubject, emailMessage, 'Automax@gmail.com', [listing.seller.user.email,], fail_silently=True)
        return JsonResponse({
            "success": True,
        })
